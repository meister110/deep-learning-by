...
def process_decoder_input(target_data, target_vocab_to_int, batch_size):
    ...
    preprocessed_target_data = tf.concat([tf.fill([batch_size, 1], 
...
def encoding_layer(rnn_inputs, rnn_size, num_layers, keep_prob, 
    ...
    stacked_lstm_cells = tf.contrib.rnn.MultiRNNCell(lstm_cells)
    encoding_cell = tf.contrib.rnn.DropoutWrapper(stacked_lstm_cells,keep_prob)
    rnn_output, rnn_state = tf.nn.dynamic_rnn(encoding_cell, embedded_input, 
...
def decoding_layer_train(encoder_state, dec_cell, dec_embed_input, 
    ...
    final_outputs,_ =  tf.contrib.seq2seq.dynamic_decode(decoder = decoder,
...
def decoding_layer_infer(encoder_state, dec_cell, dec_embeddings, start_of_sequence_id,
    ...
    outputs, _ = tf.contrib.seq2seq.dynamic_decode(decoder = inference_decoder,
                                                   impute_finished = True,
...
def seq2seq_model(input_data, target_data, keep_prob, batch_size,
    ...
    encoder_output, encoder_state = encoding_layer(input_data,
                                                  rnn_size,
                                                  num_layers,
                                                  keep_prob,
